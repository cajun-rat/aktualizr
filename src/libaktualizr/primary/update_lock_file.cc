...
// NOLINTNEXTLINE(modernize-pass-by-value) The source of this ia a long-lived config object
...
UpdateLockFile::LockResult UpdateLockFile::Acquire() {
  if (is_locked_) {
    LOG_WARNING << "Acquire called with lock already held";
    // This is a programming error, but let the update continue
    return kGoAhead;
  }
